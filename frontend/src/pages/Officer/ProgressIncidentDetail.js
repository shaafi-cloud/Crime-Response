...
function ProgressIncidentDetail() {
  const { id } = useParams();

    const officerIncidents = [
      { id: 1, type: 'Theft', status: 'In Progress', priority: 'Medium' },
      { id: 2, type: 'Assault', status: 'In Progress', priority: 'Low' },
      { id: 3, type: 'Rape', status: 'In Progress', priority: 'High' },
  ];
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-md">
      <h1 className="text-2xl font-bold mb-4">Progressed Incident Details</h1>
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <Link to="/progress" className="text-blue-500 flex items-center">
          <svg
...
export default ProgressIncidentDetail;
