...
function ResolvedIncidentDetail() {
  const { id } = useParams();

    const officerIncidents = [
    { id: 1, type: 'Theft', status: 'Pending', priority: 'High' },
    { id: 2, type: 'Assault', status: 'In Progress', priority: 'Medium' },
  ];
...
export default ResolvedIncidentDetail;
