...
function ProgressIncident() {
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-md">
      <h1 className="text-2xl font-bold mb-4">Progressed Incidents</h1>
          ...
          {assignedIncidents.map((incident) => (
            <tr key={incident.id}>
              ...
              <td className="border-b p-2">
                <Link to={`/progress/progress/${incident.id}`} className="text-blue-500">
                  View Details
                </Link>
              </td>
            </tr>
...
export default ProgressIncident;
